...
//	// нахождение данных о координат в массиве
//	// поиск в базе данных, если ли такие данные уже в бд
//	if coordPointsCheck.Id == 0 {
//		//если элемента нету такого в базе, то элемент там же и сохраняется
//	} else {
//		//получения ID записи
//	}
//
//	// нахождение данных о роутерах в массиве
//	// поиск в базе данных, если ли такие данные уже в бд
...
//	}
//
//	// нахождение данных о путях изображений в массиве
//	// поиск в базе данных, если ли такие данные уже в бд
//	if pathCheck.Id == 0 {
//		//если элемента нету такого в базе, то элемент там же и сохраняется
//	} else {
...
//	}
//
//	// нахождение данных о пользователе в массиве
//	// поиск в базе данных, если ли такие данные уже в бд
